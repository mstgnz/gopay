...
func (p *IyzicoProvider) Clone() provider.PaymentProvider {
	c := *p
	return &c
}
...
func (p *IyzicoProvider) GetCommission(ctx context.Context, request provider.CommissionRequest) (provider.CommissionResponse, error) {
